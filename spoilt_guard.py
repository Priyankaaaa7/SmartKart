...
def check_badges(data):
    if data["savedFromExpiryCount"] >= 50 and "No-Waste Warrior" not in data["badgesEarned"]:
        data["badgesEarned"].append("No-Waste Warrior")
        return "🎉 Badge Unlocked: No-Waste Warrior"
    return None
